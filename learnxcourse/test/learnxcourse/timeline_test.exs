defmodule Learnxcourse.TimelineTest do
  use Learnxcourse.DataCase

  alias Learnxcourse.Timeline

  describe "posts" do
    alias Learnxcourse.Timeline.Post

    import Learnxcourse.TimelineFixtures
